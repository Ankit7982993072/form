    ...
    render(){ 
        ...
        for (var i = 0; i < this.state.count; i += 1) {
          if(i<9)
          {
            switch(i){
             case 0:
          children.push(<Ques op2={this.option22Handler} op3={this.option23Handler} op4={this.option24Handler} op1={this.option21Handler} data1={this.changeHandler2} data={this.clickHandler} ind={i+1}/>);
             break;
             case 1:
          children.push(<Ques op2={this.option32Handler} op3={this.option33Handler} op4={this.option34Handler} op1={this.option31Handler} data1={this.changeHandler3} data={this.clickHandler} ind={i+1}/>);
             break;
             case 2:
          children.push(<Ques op2={this.option42Handler} op3={this.option43Handler} op4={this.option44Handler} op1={this.option41Handler} data1={this.changeHandler4} data={this.clickHandler} ind={i+1}/>);
             break;
             case 3:
          children.push(<Ques op2={this.option52Handler} op3={this.option53Handler} op4={this.option54Handler} op1={this.option51Handler} data1={this.changeHandler5}  data={this.clickHandler} ind={i+1}/>);
             break;
             case 4:
          children.push(<Ques  op2={this.option62Handler} op3={this.option63Handler} op4={this.option64Handler} op1={this.option61Handler} data1={this.changeHandler6} data={this.clickHandler} ind={i+1}/>);
             break;
             case 5:
          children.push(<Ques  op2={this.option72Handler} op3={this.option73Handler} op4={this.option74Handler} op1={this.option71Handler} data1={this.changeHandler7}  data={this.clickHandler} ind={i+1}/>);
             break;
             case 6:
          children.push(<Ques  op2={this.option82Handler} op3={this.option83Handler} op4={this.option84Handler} op1={this.option81Handler} data1={this.changeHandler8} data={this.clickHandler} ind={i+1}/>);
             break;
             case 7:
          children.push(<Ques  op2={this.option92Handler} op3={this.option93Handler} op4={this.option94Handler} op1={this.option91Handler} data1={this.changeHandler9} data={this.clickHandler} ind={i+1}/>);
             break;
          case 8:
      ...
      <div>
        ...
        {/* <Detail/>   */}
         <section>
           <Ques na={this.state.FORM_NAME} data={this.clickHandler} op2={this.option2Handler} op3={this.option3Handler} op4={this.option4Handler} op1={this.option1Handler} data1={this.changeHandler1} ind={0}/>
